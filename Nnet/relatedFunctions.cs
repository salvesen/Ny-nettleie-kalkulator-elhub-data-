...
namespace nettleieKalkulator1._0._0.Nnet
{
    public static class relatedFunctions
    {
        //Not used in Nnet
        private static double? weekendPower(List<DateTime> fromDate, List<double> hourlyConsumption)
        {
            try
            {
        ...
        public static bool isVinter(List<DateTime> fromDate)
        {
            ...
            if(startDate.Month > 4  || startDate.Month < 11)
            {
                return false;
            }
            else
